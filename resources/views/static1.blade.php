			...
			<!-- Main -->
				<article id="main">
					...
					<header class="special container">
						...
						<strong><h2>Nepal Earthquake 2015 </strong></h2>
						<p>India</p>
                        <p>blahblah</p>
					</header>
					...
					<!-- One -->
						<section class="wrapper style4 container">
							...
							<!-- Content -->
								<div class="content">
									<section>
										<a href="#" class="image featured"><img src="../img/napal1.jpg" alt="" /></a>
										<header>
											<h3>mm,mm,mm</h3>
										</header>
                                        
										<p>Following Nepal earthquake that struck near the Kathmandu Valley in Nepal in April and May 2015, killing more than 9,000 people and injuring more than 23,000 while leaving hundreds of thousands homeless, ICCROM, ICOMOS, ICOM, the Smithsonian, in partnership with the Nepal Department of Archaeology helped assemble a team of professionals that responded to the disaster and assisted in the recovery efforts for movable and immovable cultural heritage.
