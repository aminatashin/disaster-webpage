...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  <img class="w3-image" src="img/napal1.jpg" alt="London" width="1500" height="700">
  ...
  <div class="w3-row-padding w3-text-white w3-large">
    ...
    <div class="w3-half w3-margin-bottom">
      <div class="w3-display-container">
        <img src="{{$listing->picture}}" alt="" style="width:100%">
        <span class="w3-display-bottomleft w3-padding">{{$listing->title}}</span>
      </div>
    </div>
      ...
      {{-- <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="{{$listing->picture}}" alt="New York" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">{{$listing->title}}</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
